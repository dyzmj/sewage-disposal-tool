...
import { exportExcel2, exportWord,    initWordStorage,
...
export default {
  ...
  methods: {
    ...
    get_a_a_5_1() {
      return "净通量："+this.b16+"L/m2.h，膜面积："+this.b37+"m2/支，单套"+this.b44+"支膜";
    },
    get_a_a_5_2() {
      return this.b47;
    },
  ...
  computed: {
    ...
    data2() {
      ...
      },
      {
        ...
        单位: "台",
        数量: this.get_a_c_4_2(),
        备注: "1用1备，含配套Y型过滤器、背压阀、安全阀，缓冲器等附件，与CEB计量泵共用",
        主要材质: "泵头PVC，隔膜PTFE",
        运行时间: "0.1h",
      },
      {
    ...
    data3() {
      return [
      {
        ...
        安装位置: "超滤进水泵出口管",
        仪表名称: "就地压力表",
        规格及型号: "内充甘油耐震压力表，测量范围：0~0.3Mpa，外壳材质：不锈钢304，测量元件：SS304，Φ100mm，配表阀。",
        单位: "台",
        数量: this.get_b_a_1(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤进水支管",
        仪表名称: "压力变送器",
        规格及型号: "一体式，外壳材质：铸铝，测量范围：0～0.3MPa，输出信号：4～20mA+Hart协议，测量元件：304，配安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_a_2(),
        备注: "",
      },
      ...
      },
      {
        ...
        安装位置: "超滤产水支管",
        仪表名称: "压力变送器",
        规格及型号: "一体式，外壳材质：铸铝，测量范围：0～0.3MPa，输出信号：4～20mA+Hart协议，测量元件：SS304，配安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_a_4(),
        备注: "",
      },
      ...
      },
      {
        ...
        安装位置: "超滤产水支管",
        仪表名称: "电磁流量计",
        规格及型号: "分体式，电源：AC220V，测量范围：0~173m³/h，DN200，输出信号：4~20mA+Hart协议，本体：碳钢衬塑，电极材质：304，衬里材质：氯丁橡胶，配接地环及安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_a_6(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤产水支管",
        仪表名称: "在线浊度分析仪",
        规格及型号: "电源：AC 220V，测量范围：0~10NTU，输出信号：4~20mA，配套安装附件，电缆：10米，就地显示。",
        单位: "台",
        数量: this.get_b_a_7(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤产水箱",
        仪表名称: "超声波液位计",
        规格及型号: "一体式，电源：DC24V，测量范围：0～10米，输出信号：4～20mA+Hart协议，配安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_a_8(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤浓水错流排放管",
        仪表名称: "转子流量计",
        规格及型号: "测量范围：0~5m³/h，DN50，本体：有机玻璃，带导杆；承插连接，就地显示。",
        单位: "台",
        数量: this.get_b_a_9(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤反洗泵出口",
        仪表名称: "就地压力表",
        规格及型号: "内充甘油耐震压力表，测量范围：0~0.3Mpa，外壳材质：不锈钢304，测量元件：304，Φ100mm，配表阀。",
        单位: "台",
        数量: this.get_b_a_10(),
        备注: "",
      },
      {
        ...
        安装位置: "超滤化学清洗水箱侧壁",
        仪表名称: "磁翻板液位计",
        规格及型号: "一体式，电源：DC24V，测量范围：0～2.5米，输出信号：4～20mA+Hart协议，外壳材质：铝合金、塑料翻柱，旁通管材质：UPVC，浮子材质：UPVC，配通气阀、排污阀及安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_b_1(),
        备注: "",
      },
      ...
      },
      {
        ...
        安装位置: "超滤化学清洗水泵出水",
        仪表名称: "就地压力表",
        规格及型号: "内充甘油耐震压力表，测量范围：0~0.4Mpa，外壳材质：不锈钢304，测量元件：316L，Φ100mm，配表阀。",
        单位: "台",
        数量: this.get_b_b_3(),
        备注: "",
      },
      ...
      },
      {
        ...
        安装位置: "次氯酸钠储罐",
        仪表名称: "磁翻板液位计",
        规格及型号: "一体式，电源：DC24V，测量范围：0～2.2米，输出信号：4～20mA+Hart协议，外壳材质：铝合金、塑料翻柱，旁通管材质：PVC，浮子材质：PVC，配通气阀、排污阀及安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_c_1(),
        备注: "",
      },
      {
        ...
        安装位置: "次氯酸钠卸料泵出口",
        仪表名称: "就地压力表",
        规格及型号: "隔膜耐震压力表，测量范围：0～0.2MPa，外壳材质：PP，隔膜材质：PTFE，Φ63mm，配表阀。",
        单位: "台",
        数量: this.get_b_c_2(),
        备注: "",
      },
      {
        ...
        安装位置: "次氯酸钠计量箱",
        仪表名称: "磁翻板液位计",
        规格及型号: "一体式，电源：DC24V，测量范围：0～0.8米，输出信号：4～20mA+Hart协议，外壳材质：铝合金、塑料翻柱，旁通管材质：PVC，浮子材质：PVC，配通气阀、排污阀及安装附件，就地显示。",
        单位: "台",
        数量: this.get_b_c_3(),
        备注: "",
      },
      {
        ...
        安装位置: "化学清洗次氯酸钠计量泵出口",
        仪表名称: "就地压力表",
        规格及型号: "隔膜耐震压力表，测量范围：0～0.5MPa，外壳材质：PP，隔膜材质：PTFE，Φ63mm，配表阀。",
        单位: "台",
        数量: this.get_b_c_5(),
        备注: "",
      },
