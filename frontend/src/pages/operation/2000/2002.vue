            ...
            <div class="baseQueryParam">
              <a-form>
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b42" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b43')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b43" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b44')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b44" :disabled="true" />
                </a-form-item>
              </a-form>
            </div>
          </a-card>
            ...
            <div class="baseQueryParam">
              <a-form>
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b51" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b52')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b52" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b53')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b53" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b54')"
                  style="margin-top: 10px"
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b55" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b56')"
                  style="margin-top: 10px"
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b60" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b61')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b61" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b62')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b62" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b63')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b63" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b64')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b64" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b65')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b65" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b66')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b66" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b67')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b67" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b68')"
                  style="margin-top: 10px"
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b69" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b70')"
                  style="margin-top: 10px"
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b73" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b74')"
                  style="margin-top: 10px"
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b74" :disabled="true" />
                </a-form-item>
                <a-form-item
                  :label="$t('b75')"
                  style="margin-top: 10px"
                ...
                <a-form-item
                  ...
                  :wrapperCol="{ span: 14 }"
                >
                  <a-input v-model="b77" :disabled="true" />
                </a-form-item>
              </a-form>
            </div>
          </a-card>
...
export default {
  ...
  computed: {
    ...
    b15() {
      return (
        parseFloat(this.b8) / parseFloat(this.b9) /
    ...
    b19() {
      return (parseFloat(this.b12_1) * parseFloat(this.b17_1) + (parseFloat(this.b17_1) - 1) * parseFloat(this.b18)).toFixed(0);
    },
    b20() {
      return (parseFloat(this.b13_1) * parseFloat(this.b16) + (parseFloat(this.b16) - 1) * parseFloat(this.b18)).toFixed(1);
    },
    b21() {
      return (
        (
    ...
    b23() {
      return (Math.pow(parseFloat((
        (parseFloat(this.b3) * (1 + parseFloat(this.b6))) /
        2 /
        86400 /
        0.12
      )), 0.5) * parseFloat(this.b13_1)).toFixed(4);
    },
    b24() {
      return this.b13_1;
    },
