...
export default {
  ...
  computed: {
    ...
    b25() {
      return (
        (parseFloat(this.b21) - parseFloat(this.b23)) *
        Math.tan((parseFloat(this.b24) / 180) * 3.1415) *
        0.5
      ).toFixed(2);
    },
    b26() {
    ...
    b27() {
      return (
        (parseFloat(this.b20) +
          parseFloat(this.b22) +
          Math.sqrt(parseFloat(this.b20) * parseFloat(this.b22)) *
            parseFloat(this.b26)) /
        3
      ).toFixed(2);
    },
    ...
    b69() {
      return Math.pow(
        (1000 * 9.8 * parseFloat(this.b60)) /
          (parseFloat(this.b65) * 60 * (1.029 * Math.pow(10, -3))),
        0.5
      ).toFixed(4);
    },
    b70() {
      return Math.pow(
        (1000 * 9.8 * parseFloat(this.b61)) /
          (parseFloat(this.b66) * 60 * (1.029 * Math.pow(10, -3))),
        0.5
      ).toFixed(4);
    },
    b71() {
      return Math.pow(
        (1000 * 9.8 * parseFloat(this.b62)) /
          (parseFloat(this.b67) * 60 * (1.029 * Math.pow(10, -3))),
        0.5
      ).toFixed(4);
    },
    b72() {
