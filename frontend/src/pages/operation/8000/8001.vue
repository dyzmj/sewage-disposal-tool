...
export default {
  ...
  computed: {
    ...
    b9() {
      return (
        ((1 + parseFloat(this.b8) / 100 + parseFloat(this.b7) / 100) *
          parseFloat(this.b3)) /
        24
      ).toFixed(2);
    },
    ...
    b19() {
      return this.truncateDecimals(
        (parseFloat(this.b16) * parseFloat(this.b14) * parseFloat(this.b15)) /
          102 /
          parseFloat(this.b17),
        2
      );
    ...
    b34() {
      return this.truncateDecimals(
        (parseFloat(this.b31) * parseFloat(this.b29) * parseFloat(this.b30)) /
          102 /
          parseFloat(this.b32),
        2
      );
